...
package com.oom.masterzuo.widget;
...
public class FlexibleRatingBar extends RatingBar {
    ...
    protected synchronized void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        int desiredWidth = (int) (15 * dp * getNumStars());
    ...
    private BitmapShader updateShader(int colorOn, int colorOff) {
        ...
        float rating = getStarRating() == -1 ? getRating() : getStarRating();
        int ratingWidth = (int) (rating * getWidth() / getNumStars());
    ...
    public void setColors(String color, String bordor_color) {
        if (color != null && !color.equals("")) {
            setColorOutlineOn(Color.parseColor(color));
            setColorOutlinePressed(Color.parseColor(color));
            setColorFillOn(Color.parseColor(color));
            setColorFillPressedOn(Color.parseColor(color));
            setColorOutlineOff(Color.parseColor(color));
        }
        if (bordor_color != null && !bordor_color.equals("")) {
            setColorOutlineOff(Color.parseColor(bordor_color));
        }
    }
    ...
    public void setBorderColor(String border_color) {
        if (border_color != null && !border_color.equals("")) {
            setColorOutlineOff(Color.parseColor(border_color));
        }
    }
