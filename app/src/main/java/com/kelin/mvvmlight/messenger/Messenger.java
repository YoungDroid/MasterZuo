...
public class Messenger {
    ...
    private static < T > void sendToList( T message, Collection< WeakActionAndToken > list, Type messageTargetType, Object token ) {
        if ( list != null ) {
            ...
            for ( WeakActionAndToken item : listClone ) {
                ...
                if ( executeAction != null && item.getAction().isLive() && item.getAction().getTarget() != null && ( messageTargetType == null || item.getAction().getTarget().getClass() == messageTargetType || classImplements( item.getAction().getTarget().getClass(), messageTargetType ) ) && ( ( item.getToken() == null && token == null ) || item.getToken() != null && item.getToken().equals( token ) ) ) {
    ...
    private static < T > void unregisterFromLists( Object recipient, Action1< T > action, HashMap< Type, List< WeakActionAndToken > > lists, Class< T > tClass ) {
        Type messageType = tClass;
        ...
        synchronized ( lists ) {
            for ( WeakActionAndToken item : lists.get( messageType ) ) {
                ...
                if ( weakActionCasted != null && recipient == weakActionCasted.getTarget() && ( action == null || action == weakActionCasted.getAction1() ) ) {
    ...
    private static void unregisterFromLists( Object recipient, Action0 action, HashMap< Type, List< WeakActionAndToken > > lists ) {
        Type messageType = NotMsgType.class;
        ...
        synchronized ( lists ) {
            for ( WeakActionAndToken item : lists.get( messageType ) ) {
                ...
                if ( weakActionCasted != null && recipient == weakActionCasted.getTarget() && ( action == null || action == weakActionCasted.getAction() ) ) {
                    item.getAction().markForDeletion();
                }
            }
        }
    ...
    private static < T > void unregisterFromLists( Object recipient, Object token, Action1< T > action, HashMap< Type, List< WeakActionAndToken > > lists, Class< T > tClass ) {
        Type messageType = tClass;
        ...
        synchronized ( lists ) {
            for ( WeakActionAndToken item : lists.get( messageType ) ) {
                ...
                if ( weakActionCasted != null && recipient == weakActionCasted.getTarget() && ( action == null || action == weakActionCasted.getAction1() ) && ( token == null || token.equals( item.getToken() ) ) ) {
                    item.getAction().markForDeletion();
                }
            }
        }
    ...
    private static void unregisterFromLists( Object recipient, Object token, Action0 action, HashMap< Type, List< WeakActionAndToken > > lists ) {
        Type messageType = NotMsgType.class;
        ...
        synchronized ( lists ) {
            for ( WeakActionAndToken item : lists.get( messageType ) ) {
                ...
                if ( weakActionCasted != null && recipient == weakActionCasted.getTarget() && ( action == null || action == weakActionCasted.getAction() ) && ( token == null || token.equals( item.getToken() ) ) ) {
                    item.getAction().markForDeletion();
                }
            }
        }
